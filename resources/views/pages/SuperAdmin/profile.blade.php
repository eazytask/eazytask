                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                    ...
                                    <div class="media">
                                        <a href="javascript:void(0);" class="mr-25">
                                            <img src="{{ 'https://api.eazytask.au/' . Auth::user()->image }}"
                                    ...
                                    <!-- form -->
                                    <form action="{{ route('super-admin-profile-update') }}" method="POST" class="mt-2">
                                        @csrf
                                        <div class="row">
                                ...
                                <div class="tab-pane fade" id="account-vertical-info" role="tabpanel"
                                    ...
                                    <form class="validate-form">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-gradient-primary mt-1 mr-1">Save
                                                    changes</button>
                                                <button type="reset"
                                    ...
                                    <form class="validate-form">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <button type="submit" class="btn btn-gradient-primary mr-1 mt-1">Save
                                                    changes</button>
                                                <button type="reset"
                                                    class="btn btn-outline-secondary mt-1">Cancel</button>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="account-vertical-notifications" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-gradient-primary mt-2 mr-1">Save
                                                changes</button>
