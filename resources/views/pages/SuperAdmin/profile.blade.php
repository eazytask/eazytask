                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                        ...
                                        <div class="media">
                                            <a href="javascript:void(0);" class="mr-25">
                                                <img src="{{'/home/eklaw543/api.eazytask.au/public/'. Auth::user()->image )}}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" />
                                            </a>
                                        ...
                                        <form action="{{route('super-admin-profile-update')}}" method="POST" class="validate-form mt-2">
                                          @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-gradient-primary mt-2 mr-1">Update Profile</button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" id="accountSelect">
                                                            <option>USA</option>
                                                            <option>India</option>
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-gradient-primary mt-1 mr-1">Save changes</button>
                                        ...
                                        <form class="validate-form">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <button type="submit" class="btn btn-gradient-primary mr-1 mt-1">Save changes</button>
                                                    <button type="reset" class="btn btn-outline-secondary mt-1">Cancel</button>
                                                </div>
                                            </div>
                                        </form>
                                    ...
                                    <div class="tab-pane fade" id="account-vertical-notifications" role="tabpanel" aria-labelledby="account-pill-notifications" aria-expanded="false">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-gradient-primary mt-2 mr-1">Save changes</button>
