<div class="modal fade text-left p-md-1 p-0" id="edit{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <div class="card-body">
                                  <form class="form" action="{{route('compliance.update')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
