                    ...
                    <table id="example" class="table table-hover-animation table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{ $row->expire_date?\Carbon\Carbon::parse($row->expire_date)->format('d-m-Y'):'null' }}</td>
                                <!-- <td>
                                            @if ($row->sub_domain)
                                ...
                                <td>
                                    <button class="edit-btn btn btn-gradient-primary mb-25" data-row="{{ $json }}" data-user="{{ $user }}"><i data-feather='edit'></i></button>
                                </td>
                            </tr>
                            @endforeach
