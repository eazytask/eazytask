    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a class="btn btn-primary" href="#" id="add">Add Company-Type</a>
            </div>
            @include('pages.SuperAdmin.company_type.modals.AddModal')
                            ...
                            <td>{{$row->remarks}}</td>
                              <td>
                                <a class="edit-btn btn btn-primary" href="#" data-row="{{ $json }}"><i data-feather='edit'></i></a>
                                  <a class="btn btn-gradient-danger del" url="/company/type/delete/{{$row->id}}"><i data-feather='trash-2'></i></a>
                              </td>
                          </tr>
                          @endforeach
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".edit-btn", function() {
            ...
            $('#modalForm').attr('action', "{{ route('companyType.update') }}");
            $("#savebtn").hide()
            $("#updatebtn").show()
        ...
        function resetValue() {
            ...
            $('#modalForm').attr('action', "{{ route('companyType.store') }}");
            $("#savebtn").show()
            $("#updatebtn").hide()
        }
