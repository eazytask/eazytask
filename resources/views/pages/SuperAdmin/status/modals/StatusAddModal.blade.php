    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h4 class="modal-title text-white" id="myModalLabel17">Add Status</h4>
                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="card">
                              ...
                              <div class="card-body">
                                  <form class="form" action="{{route('status.store')}}" method="POST" id="modalForm">
                                    @csrf
                                      ...
                                      <div class="row">
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text"  class="form-control" placeholder="Status Name" id="name" name="status_name" required />
                                              </div>
                                          </div>
                                          <div class="col-md-6 col-12">
                                              <div class="form-group">
