                    ...
                    <div class="col-12">
                        <div class="card invoice-preview-card">
                            <div class="card-body invoice-padding pb-0">
                                ...
                                <form action="{{ route('supervisorstorepaymentdetails') }}" method="post">
                                    @csrf
                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td id="total-duration" class="font-weight-bold">{{$timekeeperData->sum('duration')}} Hours</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="pr-1">Total:</td>
                                                            <td id="total-amount" class="font-weight-bold">${{$timekeeperData->sum('amount')}}</td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $all_duration[$row->id] = round($row->duration,3);
                                                $all_amount[$row->id] = round($row->amount,3);
                                                @endphp
