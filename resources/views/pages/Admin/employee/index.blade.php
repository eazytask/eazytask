                    ...
                    success: function(data) {
                        ...
                        if (data.compliances.length) {
                            jQuery.each(data.compliances, function(i, val) {
                                ...
                                $("select[name='Compliance[" + i + "][compliance]']").val(val.compliance_id).change()
                                $("input[name='Compliance[" + i + "][certificate_no]']").val(val.certificate_no)
                                $("input[name='Compliance[" + i + "][comment]']").val(val.comment)
                                $("input[name='Compliance[" + i + "][expire_date]']").val(val.expire_date)
                            ...
                            $('[data-repeater-create]').click();
                            var flatpickr = $("input[name='Compliance[0][expire_date]']").flatpickr({});
                        }
