...
<script>
    function myMap(_lat = 23.87964951097153, _lon = 90.27272587563567) {
        ...
        $(document).on("click", ".load_address_map", function() {
            ...
            var address = $("#project_address").val() + '%' + $("#suburb").val() + '%' + $("#project_state").val();
            geocoder.geocode({
                'address': address
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBor5DLGlONGhBFxQdppkHF3PikRYKR_rU&callback=myMap&libraries=places"></script>
@endpush