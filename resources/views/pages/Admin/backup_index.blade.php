            ...
            <div class="card card-company-table">
                ...
                <div class="card-header">
                    <div class=" mt-3 mt-md-0">
                        <a href="/admin/home/event/request" class="btn btn-gradient-primary "><i data-feather="calendar" class="avatar-icon font-medium-3"></i></a>
                    </div>
                </div>
                <div class="d-none">
            ...
            <div class="card-body">
                ...
                <div class="card plan-card p-2" id="hasData">
                    <div class="row">
                        ...
                        <button class="btn btn-outline-success text-center border-primary taskBtn mr-25" onclick="manageTask('completed')" disabled><i data-feather="arrow-up" class="avatar-icon font-medium-3"></i></button>
