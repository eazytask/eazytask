<div class="modal fade text-left p-md-1 p-0" id="addTimeKeeper" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true" style="overflow: scroll;">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="timekeeperAddForm" data-ajax="false">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 pl-25 pr-25">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" id="roaster_date" name="roaster_date" required class="form-control format-picker" placeholder="Roster Date" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-4 pl-25 pr-25">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" id="duration" name="duration" class="form-control" placeholder="Duration" id="days" readonly="readonly" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-4 pl-25 pr-25">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" id="amount" name="amount" class="form-control" placeholder="0" readonly="readonly" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6 pl-25 pr-25">
                                                ...
                                                <!-- <div class="col-6 pl-25 pr-25 sing_body">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" id="sing_in" name="sing_in" class="form-control pickatime-format sing_body" placeholder="Sign In Time" />
                                                    </div>
                                                </div>
                                                <div class="col-6 pl-25 pr-25 sing_body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success timekeer-btn" id="addTimekeeperSubmit" onclick="timekeeperAddFunc()"><i data-feather='save'></i></button>
                    <button type="button" class="btn btn-success timekeer-btn" id="editTimekeeperSubmit" onclick="timekeeperEditFunc()" hidden><i data-feather='check'></i></button>
