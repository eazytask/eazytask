            ...
            <div class="card-header text-primary border-top-0 border-left-0 border-right-0">
                ...
                <span class="float-right">
                    <div class=" text-center">
                        ...
                        <button class="p-50 btn">
                            <span class="bullet mr-50" style='background: {{$row->color}} !important'></span>{{$row->name}}
                        </button>
                        @endforeach
                    </div>
                </span>
            ...
            <div class="card-body pt-0 pb-0">
                <div class="row row-xs">
                    ...
                    <div class="col-12 text-center">
                        ...
                        <button type="button" disabled class="btn bg-light-primary pt-50 pb-50 mr-50 mt-25" id="copyWeek"><i data-feather='copy' class="mr-50"></i>Copy All</button>
                        ...
                        <button id="download" disabled class="btn text-white bg-gradient-primary pt-50 pb-50 mr-50 mr-25"><i data-feather='download' class="mr-25"></i>Download</button>
                        <!-- </div> -->
                ...
                <div class="card">
                    <div class="container">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="mt-2 total-display p-25 pb-75 pt-75 bg-light-primary font-weight-bold border-primary rounded" style="margin-bottom: -46px; width: 308px;">
