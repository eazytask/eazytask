                        ...
                        <div class="card collapse-icon m-0">
                            ...
                            <div class="card-body pl-0 pr-0 text-center">
                                ...
                                <div class="collapse-shadow" id="accordion">
                                        ...
                                        <div id="heading11" class="bg-primary card-header text-white pb-0">
                                            <span class="lead collapse-title" style="width:100%">
                                                <div class="row" style="width:100%; margin: 4px">
                                                    ...
                                                    <div class="col-4">
                                                        <p>{{Session::get('sort_by')?Session::get('sort_by'):'Employee'}}</p>
                                                    </div>
                                    ...
                                    <div class="card p-25">
                                        <div id="heading11" class="card-header card-click pb-0 pl-0 pr-0 {{$timekeeper->id==$curr_emp?'curr':''}}" totalIds="{{$un_approved_ids->implode(',')}}" data-toggle="collapse" role="button" data-target="#accordion{{$timekeeper->id}}" aria-expanded="false" aria-controls="accordion10">
                                            <span class="lead collapse-title" style="width:100%">
                                                <div class="row" style="width:100%; margin: 4px">

                                                    <div class="col-4">
                                                        <p>{{Session::get('sort_by')=='Date'?\Carbon\Carbon::parse($timekeeper->roaster_date)->format('d-m-Y'):$timekeeper->name}}</p>
                                                    </div>
                                        ...
                                        <div id="accordion{{$timekeeper->id}}" role="tabpanel" data-parent="#accordion" aria-labelledby="heading11" class="collapse">
                                            <div class="card-body p-0">

                                                <!-- <div> -->
                                                <button class="btn btn-gradient-primary float-left m-50 taskBtn approve" url="/admin/home/timekeeper/approve/" disabled>
                                                ...
                                                <div class="col-12 pl-25 pr-25 table-responsive">
                                                    <table class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th><input type="checkbox" class="mt-75 taskcheckAllID" onclick="taskcheckAllID()"></th>
                                                                <th>Employee Name</th>
                                                                <th>Venue</th>
                                                                <th>Roster Date</th>
                                                                <th>Shift Start</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @endphp
                                                            <tr class="{{ $row->roaster_type=='Unschedueled'?'bg-light-primary':'' }} {{$row->sing_in?'':'bg-light-danger'}}">
                                                                <td class="p-0">
                                                                    @if($row->is_approved)
                                                                ...
                                                                <td class="">{{$row->sing_in ? getTime($row->sing_in): 'unspecified'}}</td>
                                                                <td class="">{{$row->sing_out ? getTime($row->sing_out): 'unspecified'}}</td>
                                                                <td>
                                                                    {{ $row->ratePerHour }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="p-50">
                                                                        ...
                                                                        <a class="btn btn-gradient-danger del text-white" url="/admin/home/view/schedule/delete/{{ $row->id }}"><i data-feather='trash-2'></i></a>
                                                                        @else
                                                                        <button class="edit-btn btn btn-gradient-primary mb-25" data-row="{{ $json }}"><i data-feather='eye'></i></button>
                                                                        @endif
                                                                    </div>
                                        ...
                                        <div id="heading11" class="card-header pb-0" style="background: #ddd;">
                                            <span class="lead collapse-title" style="width:100%">
                                                <div class="row" style="width:100%">
                                                    ...
                                                    <div class="col-4">
                                                        <p>{{count($timekeepers)}} {{Session::get('sort_by')?Session::get('sort_by'):'Employee'}}</p>
                                                    </div>
...
<script>
    pdf_preview = function(rep) {
        if ((!window.scheduleFullReport && rep == 'full_report') || (!window.scheduleSummeryReport && rep == 'summery_report')) {
            $("#pdf_viewer").attr('src', '')
