    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h4 class="modal-title text-white" id="myModalLabel17">Schedule</h4>
            ...
            <form action="{{ route('view-update-timekeeper') }}" method="POST" id="newModalForm">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success timekeer-btn"><i data-feather='check'></i></button>
                    <button type="button" class="btn btn-outline-dark edit-discard" data-dismiss="modal"><i data-feather='x'></i></button>
                </div>
            </form>
        </div>
    </div>
