<div class="modal fade text-start p-md-1 p-0" data-backdrop="static" data-keyboard="false" id="editTimeKeeper" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <form class="modal-content" action="{{ route('view-update-timekeeper') }}" method="POST" id="newModalForm">
