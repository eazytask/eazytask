    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 mt-1">
                    <button class="btn btn-outline-primary mt-25 ml-25 test" type="button" onclick="show_data()">Show</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="container">
                        <div class="table-responsive">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Form</button>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" method="post" action="/admin/home/all/report/search/email"> 
                  ...
                  <div class="form-group">
                    <div class="d-flex col-sm-offset-3 col-sm-6 col-sm-offset-3">
                      ...
                      <button class="btn-lg btn-primary" type="button" data-dismiss="modal">Close</button> 
                    </div>
                  </div>
                  <!--end Form-->
                </form>
