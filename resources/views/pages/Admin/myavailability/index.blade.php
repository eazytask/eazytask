        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{$session_start?'':'active'}}" id="home-tab" data-toggle="tab" href="#home" aria-controls="home" role="tab" aria-selected="true">Current unavailability days</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{$session_start?'active':''}}" id="profile-tab" data-toggle="tab" href="#profile" aria-controls="profile" role="tab" aria-selected="false">See total unavailability days</a>
                    </li>
                </ul>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!($row->start_date <= \Carbon\Carbon::now())) <button class="btn edit-btn btn-gradient-primary" data-row="{{ $json }}"><i data-feather='edit'></i></button>
                                                <a class="btn btn-gradient-danger text-white del mt-lg-25" url="/admin/home/myavailability/delete/{{ $row->id }}"><i data-feather='trash-2'></i></a>
