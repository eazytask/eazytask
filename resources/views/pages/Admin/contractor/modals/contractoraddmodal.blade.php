<div class="modal fade text-left p-md-1 p-0" id="addContractor" role="dialog" aria-labelledby="myModalLabel17"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h4 class="modal-title text-white" id="myModalLabel17">Add Contractor</h4>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-6">
                                                                <div class="form-group">
                                                                    <label for="first-name-column">Contractor Name
                                                                        *</label>
                                                                    <input type="text" class="form-control"
                                                                        placeholder="Contractor Name" name="cname"
                                                                        id="cname" required />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-6">
                                                            ...
                                                            <div class="col-md-6 col-6">
                                                                <div class="form-group">
                                                                    <label for="last-name-column">Contact Number
                                                                        *</label>
                                                                    <input type="text" minlength="10" maxlength="10"
                                                                        class="form-control"
                                                                        placeholder="Contact Number" name="cnumber"
                                                                        id="cnumber" required />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="cimage" name="file"
                                                                        hidden>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-6">
                                                                <div class="form-group">
                                                                    <label for="email-id-column">Contact Person
                                                                        *</label>
                                                                    <input type="text" class="form-control"
                                                                        name="cperson" id="cperson"
                                                            ...
                                                            <div class="col-md-6 col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" minlength="4"
                                                                        ...
                                                                        name="cpostal_code" id="cpostal_code"
