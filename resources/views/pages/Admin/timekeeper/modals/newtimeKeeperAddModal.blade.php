    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info-subtle py-2">
                <h5 class="modal-title" id="myModalLabel17">Timesheet</h5>
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pl-25 pr-25">
                                                ...
                                                <div class="mb-3">
                                                    <select class="form-control select2" name="employee_ids[]" id="employee_id" aria-label="Default select example" required>
