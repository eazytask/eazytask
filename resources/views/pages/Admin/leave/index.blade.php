...
$start_date="";
$end_date = "";
$session_start =Session::get('leave_start_date');
$session_end =Session::get('leave_end_date');

if($session_start){
$start_date = \Carbon\Carbon::parse($session_start)->format('d-m-Y');
}else{
$start_date = \Carbon\Carbon::now()->startOfYear()->format('d-m-Y');
}
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">My Leave days</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/home/{{ Auth::user()->company_roles->first()->company->id }}">Home</a>
                        </li>
                        <li class="breadcrumb-item active">My Leave day Lists
                        </li>
                    </ol>
                </div>
            </div>
...
<div class="row" id="table-hover-animation">
    <div class="col-12">
        <div class="card">
            ...
            @include('pages.Admin.leave.modals.AddModal')

            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{$session_start?'':'active'}}" id="home-tab" data-toggle="tab" href="#home" aria-controls="home" role="tab" aria-selected="true">Current leave days</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{$session_start?'active':''}}" id="profile-tab" data-toggle="tab" href="#profile" aria-controls="profile" role="tab" aria-selected="false">See total leave days</a>
                    </li>
                </ul>
                
                <div class="tab-content">
                    <div class="tab-pane {{$session_start?'':'active'}}" id="home" aria-labelledby="home-tab" role="tabpanel">
                            ...
                            <table class="table table-hover-animation table-bordered mb-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!($row->start_date <= \Carbon\Carbon::now())) <button class="btn edit-btn btn-gradient-primary" data-row="{{ $json }}"><i data-feather='edit'></i></button>
                                                <a class="btn btn-gradient-danger text-white del mt-lg-25" url="/admin/home/leave/delete/{{ $row->id }}"><i data-feather='trash-2'></i></a>
                    ...
                    <div class="tab-pane {{$session_start?'active':''}}" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                        <div class="card-header pb-0 pt-0">
                            <h4>All approved leave days</h4>

                            <div>
                                <form action="{{ route('leave.search') }}" method="POST" id="dates_form">
                                    @csrf
                                    <div class="row row-xs">
                                        <div class="col-lg-4">
                                            <input type="text" name="start_date" required class="form-control format-picker" placeholder="From" value="{{$start_date}}" />
                                        </div>
                                        <div class="col-lg-4 mt-25 mt-md-0 ">
                                            <input type="text" name="end_date" required class="form-control format-picker" placeholder="To" value="{{$end_date}}" />
                                        </div>
                                    ...
                                    <table class="table table-bordered mb-4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn bg-gradient-primary" href="#" data-toggle="modal" data-target="#detailModal{{ $row->id }}">Details</a>
                                                    @include('pages.Admin.leave.modals.DetailsModal')
                                                </td>
                                            </tr>
                                            @endforeach
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".edit-btn", function() {
            ...
            $('#newModalForm').attr('action', "/admin/home/leave/update");
            $("#savebtn").hide()
            $("#updatebtn").show()
        ...
        function resetValue() {
            ...
            $('#newModalForm').attr('action', "/admin/home/leave/store");
            $("#savebtn").show()
            $("#updatebtn").hide()
        }
