                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link {{ $session_start ? '' : 'active' }}" id="home-tab" data-toggle="tab"
                                href="#home" aria-controls="home" role="tab" aria-selected="true">Current leave
                                days</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $session_start ? 'active' : '' }}" id="profile-tab" data-toggle="tab"
                                href="#profile" aria-controls="profile" role="tab" aria-selected="false">See total leave
                                days</a>
                        </li>
                    </ul>
                                                ...
                                                <td>
                                                    @if (!($row->start_date <= \Carbon\Carbon::now()))
                                                        ...
                                                        <a class="btn btn-gradient-success text-white del mt-lg-25"
                                                            url="/admin/home/leave/approve/{{ $row->id }}"><i
