<div class="modal fade text-left p-md-1 p-0" id="addEventModal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="col-12 pl-25 pr-25">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="event_date"
                                                        ...
                                                        placeholder="Event date" name="event_date" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6 pl-25 pr-25">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="no_employee_required"
                                                        ...
                                                        placeholder="How many employee required" required />
                                                </div>
                                            </div>
