        ...
        <div class="container p-0">
            ...
            <div class="card-body pt-0 pb-0">
                <div class="row row-xs">
                    <div class="col-md-4 mb-1"><span class="font-weight-bolder float-left mt-1 mr-25 text-capitalize">Search a date:</span>
                        <input type="text" id="search_date" name="search_date" class="form-control format-picker mt-75 form-control-sm float-left text-center bg-light-info" placeholder="dd-mm-yyyy" style="width:135px">
                    </div>
                ...
                <div class="card">
                    <div class="container">
                        <div class="table-responsive">
                            ...
                            <button class="mt-2 p-75 btn btn-primary approve" style="margin-bottom: -78px;" onclick="approveAllFunc()" hidden>Approve All <i data-feather='check-circle'></i></button>
                            <div class="mt-2 p-50 bg-light-primary font-weight-bold border-primary rounded" style="margin:0 0 -46px 115px; width: 305px;">
