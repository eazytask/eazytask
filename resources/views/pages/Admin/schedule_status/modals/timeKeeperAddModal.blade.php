    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary">
                <h4 class="modal-title text-light" id="myModalLabel17">Schedule</h4>
            ...
            <form method="POST" id="timekeeperAddForm" data-ajax="false">
                                                        ...
                                                        <div class="card-body pb-0">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 col-6 pl-25 pr-25">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" disabled id="shift_start" class="form-control pickatime-format" readonly />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 col-6 pl-25 pr-25">
                                                                    <label for="email-id-column">Shift End</label>
                                                                    <div class="form-group">
                                                                        <input type="text" disabled id="shift_end" class="form-control pickatime-format" readonly />
                                                                    </div>
                                                                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-dark" data-dismiss="modal">Cancel <i data-feather='x'></i></button>
                    <button type="button" class="btn btn-success timekeer-btn" id="editTimekeeperSubmit" onclick="timekeeperEditFunc()">Approved <i data-feather='check-circle'></i></button>
                </div>
            </form>
        </div>
    </div>
