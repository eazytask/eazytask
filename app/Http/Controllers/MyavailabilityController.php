...
class MyavailabilityController extends Controller
{
    ...
    {
        Session::put('availity_start_date', '');
        Session::put('availity_end_date', '');
    ...
    {
        $start_date = Session::get('availity_start_date') ? Session::get('availity_start_date') : Carbon::now()->startOfYear();
        $end_date = Session::get('availity_end_date') ? Session::get('availity_end_date') : Carbon::now();
    ...
    public function userIndex()
    {
        ...
        $leave_types = LeaveType::all();
        return view("pages.User.myavailability.index", compact('data','leaves','leave_types'));
    }
