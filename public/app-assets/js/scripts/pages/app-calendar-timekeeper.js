...
//custom function for shift start and end time
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function eventClick(info) {
    ...
    if(eventToUpdate.extendedProps.payment_status  ==  1){
    ...
    project_id.val(eventToUpdate.extendedProps.project_id).trigger('change');
    ...
    $("#roaster_date").val(moment(eventToUpdate.extendedProps.roaster_date).format('DD-MM-YYYY'))
    $("#shift_start").val($.time(eventToUpdate.extendedProps.shift_start))
    $("#shift_end").val($.time(eventToUpdate.extendedProps.shift_end))
  ...
  btnDeleteEvent.on('click', function () {      
      ...
      if(eventToUpdate.extendedProps.tid!='')
      {
        $.ajax({
            ...
            url: "/admin/home/calendar/delete",
            type: "delete",
            dataType: 'json',
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    $("#roaster_date").val(moment(new Date()).format('DD-MM-YYYY'))
    },
  ...
  updateEventBtn.on('click', function () {
    if (eventForm.valid()) {
      $.ajax({
          ...
          url: "/admin/home/calendar/update",
          type: "POST",
          dataType: 'json',
          success: function (data) {  
            if(data['alert-type']=="success")
