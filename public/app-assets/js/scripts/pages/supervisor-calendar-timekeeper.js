  ...
  btnDeleteEvent.on('click', function () {      
      ...
      if(eventToUpdate.extendedProps.tid!='')
      {
        $.ajax({
            ...
            url: "/supervisor/home/roaster/calender/delete",
            type: "delete",
            dataType: 'json',
  ...
  $(addEventBtn).on('click', function () {
    if (eventForm.valid()) {
      $.ajax({
          ...
          url: "/supervisor/home/roaster/calender/store",
          type: "POST",
          dataType: 'json',
          success: function (data) {
            if(data['alert-type']=="success")
  ...
  updateEventBtn.on('click', function () {
    if (eventForm.valid()) {
      $.ajax({
          ...
          url: "/supervisor/home/roaster/calender/update",
          type: "POST",
          dataType: 'json',
          success: function (data) {  
            if(data['alert-type']=="success")
